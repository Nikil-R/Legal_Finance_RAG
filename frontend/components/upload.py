...
def render_upload_section():
    ...
    st.sidebar.caption("Upload personal documents to search alongside government rules.")
    ...
    try:
        ...
        if resp.status_code == 200:
            ...
            if docs:
                ...
                if st.sidebar.button("🗑️ Clear My Documents", type="secondary", use_container_width=True):
                    requests.delete(f"{API_BASE_URL}/api/v1/user/documents/{session_id}")
