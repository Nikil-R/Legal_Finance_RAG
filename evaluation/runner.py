...
from evaluation.golden_dataset import GoldenDataset  # noqa: E402
...
def main():
    ...
    parser.add_argument(
        "--dataset-info", action="store_true", help="Show dataset information and exit"
    )
    ...
    result = evaluator.evaluate_all(
        domain_filter=domain_filter, difficulty_filter=args.difficulty, limit=args.limit
    )
