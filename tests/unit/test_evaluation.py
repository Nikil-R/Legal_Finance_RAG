...
class TestRetrievalRelevanceScorer:
    ...
    def test_relevant_retrieval(self):
        ...
        sources = [
            {"content": "Section 80C deductions for PPF", "domain": "tax", "relevance_score": 0.9},
            {"content": "ELSS investments under 80C", "domain": "tax", "relevance_score": 0.8}
        ]
...
class TestReporter:
    ...
    def test_console_report(self):
        ...
        result = EvaluationResult(
            ...
            difficulty_scores={"easy": {"count": 5, "avg_score": 0.85, "pass_rate": 0.9}},
            question_results=[],
